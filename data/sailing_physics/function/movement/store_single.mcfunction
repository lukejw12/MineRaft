...
execute if entity @s[type=interaction] run function sailing_physics:movement/store_scores
execute unless entity @s[type=interaction] run function sailing_physics:movement/store_nbt
