...
tellraw @s [{"bold":false,"color":"yellow","italic":false,"text":"- Weather "},"[",{"click_event":{"action":"run_command","command":"/function admin_commands:gameplay_menu/controls/weather/main"},"color":"aqua","text":"Expand"},{"color":"gold","text":"]"}]
tellraw @s [{"bold":false,"color":"gold","italic":false,"text":"- Stats "},"[",{"click_event":{"action":"run_command","command":"/function admin_commands:gameplay_menu/controls/stats/main"},"color":"aqua","text":"Expand"},{"color":"gold","text":"]"}]
