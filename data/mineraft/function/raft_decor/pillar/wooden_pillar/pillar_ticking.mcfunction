...
execute unless block ~ ~2 ~ end_rod run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{wooden_support:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["wooden_support"]},"minecraft:item_model":"minecraft:wooden_pillar","minecraft:item_name":'Wooden Pillar',"minecraft:rarity":"uncommon"}}}
...
execute unless block ~ ~-1 ~ #minecraft:raft_materials run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{wooden_support:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["wooden_support"]},"minecraft:item_model":"minecraft:wooden_pillar","minecraft:item_name":'Wooden Pillar',"minecraft:rarity":"uncommon"}}}
