...
execute if entity @s[tag=valid_northeast] run scoreboard players add #max l_junction_wall_id 1
execute if entity @s[tag=valid_northeast] run scoreboard players operation #current l_junction_wall_id = #max l_junction_wall_id

execute if entity @s[tag=valid_northeast] run summon marker ~ ~ ~ {Tags:["solid_l_junction_wall_active","facing_northeast","recent_spawned"]}
execute if entity @s[tag=valid_northeast] run playsound minecraft:block.wood.place block @a[distance=..10] ~ ~ ~ 1 0.8 1
execute if entity @s[tag=valid_northeast] run summon item_display ~1 ~.3 ~-1 {Rotation:[-90f,0f],item_display:"ground",Tags:["l_junction_wall_facade","facing_northeast","wall_item","recent_spawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:item_model":"minecraft:solid_l_junction_wall","minecraft:enchantment_glint_override":false}}}
execute if entity @s[tag=valid_northeast] run fill ~ ~ ~ ~2 ~2 ~ blue_stained_glass
execute if entity @s[tag=valid_northeast] run fill ~ ~ ~ ~ ~2 ~-2 blue_stained_glass
execute if entity @s[tag=valid_northeast] run scoreboard players operation @e[tag=recent_spawned] l_junction_wall_id = #current l_junction_wall_id
execute if entity @s[tag=valid_northeast] run tag @e[tag=recent_spawned] remove recent_spawned
...
execute if entity @s[tag=valid_southeast] run scoreboard players add #max l_junction_wall_id 1
execute if entity @s[tag=valid_southeast] run scoreboard players operation #current l_junction_wall_id = #max l_junction_wall_id

execute if entity @s[tag=valid_southeast] run summon marker ~ ~ ~ {Tags:["solid_l_junction_wall_active","facing_southeast","recent_spawned"]}
execute if entity @s[tag=valid_southeast] run playsound minecraft:block.wood.place block @a[distance=..10] ~ ~ ~ 1 0.8 1
execute if entity @s[tag=valid_southeast] run summon item_display ~1 ~.3 ~1 {Rotation:[0f,0f],item_display:"ground",Tags:["l_junction_wall_facade","facing_southeast","wall_item","recent_spawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:item_model":"minecraft:solid_l_junction_wall","minecraft:enchantment_glint_override":false}}}
execute if entity @s[tag=valid_southeast] run fill ~ ~ ~ ~2 ~2 ~ blue_stained_glass
execute if entity @s[tag=valid_southeast] run fill ~ ~ ~ ~ ~2 ~2 blue_stained_glass
execute if entity @s[tag=valid_southeast] run scoreboard players operation @e[tag=recent_spawned] l_junction_wall_id = #current l_junction_wall_id
execute if entity @s[tag=valid_southeast] run tag @e[tag=recent_spawned] remove recent_spawned
...
execute if entity @s[tag=valid_southwest] run scoreboard players add #max l_junction_wall_id 1
execute if entity @s[tag=valid_southwest] run scoreboard players operation #current l_junction_wall_id = #max l_junction_wall_id

execute if entity @s[tag=valid_southwest] run summon marker ~ ~ ~ {Tags:["solid_l_junction_wall_active","facing_southwest","recent_spawned"]}
execute if entity @s[tag=valid_southwest] run playsound minecraft:block.wood.place block @a[distance=..10] ~ ~ ~ 1 0.8 1
execute if entity @s[tag=valid_southwest] run summon item_display ~-1 ~.3 ~1 {Rotation:[90f,0f],item_display:"ground",Tags:["l_junction_wall_facade","facing_southwest","wall_item","recent_spawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:item_model":"minecraft:solid_l_junction_wall","minecraft:enchantment_glint_override":false}}}
execute if entity @s[tag=valid_southwest] run fill ~ ~ ~ ~-2 ~2 ~ blue_stained_glass
execute if entity @s[tag=valid_southwest] run fill ~ ~ ~ ~ ~2 ~2 blue_stained_glass
execute if entity @s[tag=valid_southwest] run scoreboard players operation @e[tag=recent_spawned] l_junction_wall_id = #current l_junction_wall_id
execute if entity @s[tag=valid_southwest] run tag @e[tag=recent_spawned] remove recent_spawned
...
execute if entity @s[tag=valid_northwest] run scoreboard players add #max l_junction_wall_id 1
execute if entity @s[tag=valid_northwest] run scoreboard players operation #current l_junction_wall_id = #max l_junction_wall_id

execute if entity @s[tag=valid_northwest] run summon marker ~ ~ ~ {Tags:["solid_l_junction_wall_active","facing_northwest","recent_spawned"]}
execute if entity @s[tag=valid_northwest] run playsound minecraft:block.wood.place block @a[distance=..10] ~ ~ ~ 1 0.8 1
execute if entity @s[tag=valid_northwest] run summon item_display ~-1 ~.3 ~-1 {Rotation:[180f,0f],item_display:"ground",Tags:["l_junction_wall_facade","facing_northwest","wall_item","recent_spawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:item_model":"minecraft:solid_l_junction_wall","minecraft:enchantment_glint_override":false}}}
execute if entity @s[tag=valid_northwest] run fill ~ ~ ~ ~-2 ~2 ~ blue_stained_glass
execute if entity @s[tag=valid_northwest] run fill ~ ~ ~ ~ ~2 ~-2 blue_stained_glass
execute if entity @s[tag=valid_northwest] run scoreboard players operation @e[tag=recent_spawned] l_junction_wall_id = #current l_junction_wall_id
execute if entity @s[tag=valid_northwest] run tag @e[tag=recent_spawned] remove recent_spawned
