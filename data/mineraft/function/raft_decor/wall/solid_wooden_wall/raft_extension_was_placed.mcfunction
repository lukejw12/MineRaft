...
execute if entity @s[tag=valid] run scoreboard players add #max solid_wall_id 1
execute if entity @s[tag=valid] run scoreboard players operation #current solid_wall_id = #max solid_wall_id

execute if entity @s[tag=valid] run summon marker ~ ~ ~ {Tags:["solid_wooden_wall_active","facing_east_west","recent_spawned"]}
execute if entity @s[tag=valid] run playsound minecraft:block.wood.place block @a[distance=..10] ~ ~ ~ 1 0.8 1
execute if entity @s[tag=valid] run summon item_display ~ ~0.3 ~ {item_display:"ground",Rotation:[90F,0F],Tags:["solid_wall_facade","facing_east_west","recent_spawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:item_model":"minecraft:solid_wooden_wall","minecraft:enchantment_glint_override":false}}}
execute if entity @s[tag=valid] run fill ~-1 ~ ~ ~1 ~2 ~ blue_stained_glass replace air
execute if entity @s[tag=valid] run scoreboard players operation @e[tag=recent_spawned] solid_wall_id = #current solid_wall_id
execute if entity @s[tag=valid] run tag @e[tag=recent_spawned] remove recent_spawned
...
execute if entity @s[tag=valid] run summon marker ~ ~ ~ {Tags:["solid_wooden_wall_active","facing_north_south","recent_spawned"]}
execute if entity @s[tag=valid] run playsound minecraft:block.wood.place block @a[distance=..10] ~ ~ ~ 1 0.8 1
execute if entity @s[tag=valid] run summon item_display ~ ~0.3 ~ {item_display:"ground",Rotation:[0F,0F],Tags:["solid_wall_facade","facing_north_south","recent_spawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:blue_stained_glass",count:1,components:{"minecraft:item_model":"minecraft:solid_wooden_wall","minecraft:enchantment_glint_override":false}}}
