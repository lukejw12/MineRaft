...
execute as @s[tag=mr.support_display] at @s run function mineraft:structures/support/tick
execute as @s[tag=mr.wall_display] at @s run function mineraft:structures/walls/tick
execute as @s[tag=mr.platform_display] at @s run function mineraft:structures/platform/tick