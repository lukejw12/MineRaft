...
execute positioned ~ ~3 ~ as @e[type=item_display,tag=mr.support_display,distance=..1,limit=1,sort=nearest] at @s run function mineraft:structures/support/destroy
kill @s
...
execute unless entity @e[tag=mr.support] run say support gone --support-destooroy