...
execute if entity @e[type=item_display,tag=mr.newly_marked] run say Marked more platforms
...
execute if score #filled_any mr.data matches 1 run function mineraft:structures/support/flood_fill_mark