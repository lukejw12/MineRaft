...
execute positioned ~ ~-2.79 ~ as @e[type=item_display,tag=mr.support_display,distance=..0.5,limit=1] at @s run function mineraft:structures/support/count_platforms
...
execute positioned ~3 ~-2.79 ~ as @e[type=item_display,tag=mr.support_display,distance=..0.5,limit=1] at @s run function mineraft:structures/support/count_platforms
...
execute positioned ~ ~-2.79 ~3 as @e[type=item_display,tag=mr.support_display,distance=..0.5,limit=1] at @s run function mineraft:structures/support/count_platforms
