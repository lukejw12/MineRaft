...
execute if score @s mr.support_value matches 0 run say Checking for support below
...
execute if score @s mr.support_value matches 0 positioned ~ ~-2 ~ if entity @e[type=item_display,tag=mr.support_display,distance=..1,limit=1] run say Found a support below, checking if it matches platform support_id
execute if score @s mr.support_value matches 0 positioned ~ ~-2 ~ as @e[type=item_display,tag=mr.support_display,distance=..1,limit=1] if score @s mr.support_id = @e[type=item_display,tag=mr.platform_display,sort=nearest,limit=1,tag=mr.needs_validation] mr.support_id run say Support ID matches!
...
execute if score @s mr.support_value matches 1 positioned ~3 ~ ~ if entity @e[type=item_display,tag=mr.platform_display,distance=..0.7,limit=1,tag=!mr.needs_validation] run say Found validated platform to east
...
execute if score @s mr.support_value matches 2 positioned ~-3 ~ ~ if entity @e[type=item_display,tag=mr.platform_display,distance=..0.7,limit=1,tag=!mr.needs_validation] run say Found validated platform to west
...
execute if score @s mr.support_value matches 3 positioned ~ ~ ~3 if entity @e[type=item_display,tag=mr.platform_display,distance=..0.7,limit=1,tag=!mr.needs_validation] run say Found validated platform to south
...
execute if score @s mr.support_value matches 4 positioned ~ ~ ~-3 if entity @e[type=item_display,tag=mr.platform_display,distance=..0.7,limit=1,tag=!mr.needs_validation] run say Found validated platform to north
...
execute if score #has_valid_support mr.data matches 1 run say Platform validated
