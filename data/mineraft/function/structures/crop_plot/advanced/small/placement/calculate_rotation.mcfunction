...
execute if score #rotation mr.data matches -45..45 run data modify storage mineraft:crop_plot crop2_offset_x set value 0.167
execute if score #rotation mr.data matches -45..45 run data modify storage mineraft:crop_plot crop2_offset_z set value 0.5
execute if score #rotation mr.data matches -45..45 run data modify storage mineraft:crop_plot crop3_offset_x set value -0.167
execute if score #rotation mr.data matches -45..45 run data modify storage mineraft:crop_plot crop3_offset_z set value 0.5
execute if score #rotation mr.data matches -45..45 run data modify storage mineraft:crop_plot crop4_offset_x set value -0.5
execute if score #rotation mr.data matches -45..45 run data modify storage mineraft:crop_plot crop4_offset_z set value 0.5
...
execute if score #rotation mr.data matches 45..135 run data modify storage mineraft:crop_plot crop2_offset_z set value 0.167
execute if score #rotation mr.data matches 45..135 run data modify storage mineraft:crop_plot crop3_offset_x set value 0.5
execute if score #rotation mr.data matches 45..135 run data modify storage mineraft:crop_plot crop3_offset_z set value -0.167
execute if score #rotation mr.data matches 45..135 run data modify storage mineraft:crop_plot crop4_offset_x set value 0.5
execute if score #rotation mr.data matches 45..135 run data modify storage mineraft:crop_plot crop4_offset_z set value -0.5
...
execute if score #rotation mr.data matches 135.. run data modify storage mineraft:crop_plot crop2_offset_x set value 0.833
execute if score #rotation mr.data matches 135.. run data modify storage mineraft:crop_plot crop2_offset_z set value 0.5
execute if score #rotation mr.data matches 135.. run data modify storage mineraft:crop_plot crop3_offset_x set value 1.167
execute if score #rotation mr.data matches 135.. run data modify storage mineraft:crop_plot crop3_offset_z set value 0.5
execute if score #rotation mr.data matches 135.. run data modify storage mineraft:crop_plot crop4_offset_x set value 1.5
execute if score #rotation mr.data matches 135.. run data modify storage mineraft:crop_plot crop4_offset_z set value 0.5
...
execute if score #rotation mr.data matches -135..-45 run data modify storage mineraft:crop_plot crop2_offset_z set value 0.833
execute if score #rotation mr.data matches -135..-45 run data modify storage mineraft:crop_plot crop3_offset_x set value 0.5
execute if score #rotation mr.data matches -135..-45 run data modify storage mineraft:crop_plot crop3_offset_z set value 1.167
execute if score #rotation mr.data matches -135..-45 run data modify storage mineraft:crop_plot crop4_offset_x set value 0.5
execute if score #rotation mr.data matches -135..-45 run data modify storage mineraft:crop_plot crop4_offset_z set value 1.5