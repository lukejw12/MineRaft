...
execute as @a[tag=mr.interacting] if items entity @s weapon.mainhand *[custom_data~{mr.pail-freshwater:1b}] run function mineraft:structures/crop_plot/advanced/small/interaction/water
