...
execute align xyz positioned ~ ~1 ~ unless block ~ ~ ~ air unless block ~ ~ ~ iron_trapdoor run function mineraft:structures/crop_plot/advanced/small/raycast/preview/hide
...
execute align xyz positioned ~ ~1 ~ as @e[type=item_display,tag=mr.small_adv_crop_plot_preview] if score @s mr.link = #player_link mr.data run function mineraft:structures/crop_plot/advanced/small/raycast/preview/position with storage mineraft:crop_plot
