...
execute as @e[type=marker,tag=mr.crop_plot_preview_raycast,limit=1,sort=nearest] at @s run function mineraft:structures/crop_plot/advanced/large/raycast/preview/loop