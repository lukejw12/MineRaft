...
function mineraft:structures/crop_plot/advanced/large/interaction/give_loop

execute if score @s mr.crop_plot_hits matches 5.. run function mineraft:structures/crop_plot/advanced/large/interaction/reset
