...
execute as @a[tag=mr.interacting] if items entity @s weapon.mainhand *[custom_data~{mr.filled_cup:1b,mr.water_type:"freshwater"}] run function mineraft:structures/crop_plot/advanced/large/interaction/water
