...
execute at @e[type=item_display,tag=mr.new_display,limit=1] positioned ~0.5 ~-1 ~0.5 as @e[type=item_display,tag=mr.surface,distance=..3,limit=1,sort=nearest] run function mineraft:grid/block/set_height_block {height:5}
