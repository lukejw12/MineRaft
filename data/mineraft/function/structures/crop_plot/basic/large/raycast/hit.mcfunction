...
execute as @e[type=item_display,tag=mr.foundation,distance=..2,limit=1,sort=nearest] at @s align xyz positioned ~0.5 ~1 ~0.5 run function mineraft:structures/crop_plot/basic/large/placement/check_space
execute unless entity @e[type=item_display,tag=mr.foundation,distance=..2] as @e[type=item_display,tag=mr.platform_display,distance=..2,limit=1,sort=nearest] at @s positioned ~ ~0.3 ~ run function mineraft:structures/crop_plot/basic/large/placement/check_space
