execute if score #sp.sailing sp.data matches 0 unless block ~1 ~ ~1 barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~1 ~ ~ barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~1 ~ ~-1 barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~ ~ ~1 barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~ ~ ~ barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~ ~ ~-1 barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~-1 ~ ~1 barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~-1 ~ ~ barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
execute if score #sp.sailing sp.data matches 0 unless block ~-1 ~ ~-1 barrier run function mineraft:structures/crop_plot/basic/large/core/destroy
