...
execute as @e[tag=mr.target_crop_plot] run scoreboard players set @s mr.purifier_fuel 3
execute as @e[tag=mr.target_crop_plot] run function mineraft:structures/crop_plot/basic/small/models/plot/update
