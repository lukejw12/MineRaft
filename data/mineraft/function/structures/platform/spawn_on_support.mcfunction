schedule function mineraft:debug/check_support_exists 2t append
...
execute positioned ~ ~-2 ~ unless entity @e[type=item_display,tag=mr.support_display,distance=..0.7] run return fail

execute positioned ~ ~-2 ~ as @e[type=item_display,tag=mr.support_display,distance=..0.7,limit=1] run tag @s add mr.placing_platform
execute positioned ~ ~-2 ~ as @e[type=item_display,tag=mr.support_display,distance=..0.7,limit=1] at @s run function mineraft:structures/platform/hide_support_top
...
execute as @e[type=item_display,tag=mr.new_platform,limit=1] positioned ~ ~-2 ~ run scoreboard players operation @s mr.support_id = @e[type=item_display,tag=mr.support_display,distance=..0.7,limit=1] mr.support_id
...
execute positioned ~ ~-2 ~ as @e[type=item_display,tag=mr.support_display,distance=..0.7,limit=1] run tag @s remove mr.placing_platform
