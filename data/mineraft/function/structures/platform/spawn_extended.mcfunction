...
function mineraft:structures/support/has_capacity_at_position
...
execute positioned ~ ~-0.71 ~ run function mineraft:structures/platform/spawn_display with storage mineraft:platform
