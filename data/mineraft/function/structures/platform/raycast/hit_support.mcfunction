...
execute as @e[type=item_display,tag=mr.support_display,distance=..2.5,limit=1,sort=nearest] at @s positioned ~0.5 ~ ~0.5 as @e[type=item_display,tag=mr.surface,distance=..3,limit=1,sort=nearest] run function mineraft:grid/support/has_capacity
