...
execute as @e[type=item_display,tag=mr.support_display,distance=..2.5,limit=1,sort=nearest] at @s align xyz run function mineraft:structures/support/count_platforms
...
execute as @e[type=item_display,tag=mr.support_display,distance=..2.5,limit=1,sort=nearest] at @s align xyz positioned ~0.5 ~2 ~0.5 run function mineraft:structures/platform/spawn_on_support
