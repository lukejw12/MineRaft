...
execute as @e[type=item_display,tag=mr.support_display,distance=..2,limit=1,sort=nearest] if score @s mr.support_count matches 5.. run return run function mineraft:structures/platform/raycast/preview/hide
