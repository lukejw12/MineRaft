...
execute as @e[type=item_display,tag=mr.wall_display] if score @s mr.wall_id = #check_id1 mr.data at @s store result score #wall1_valid mr.data run function mineraft:structures/walls/check_wall_corner_validity
execute as @e[type=item_display,tag=mr.wall_display] if score @s mr.wall_id = #check_id2 mr.data at @s store result score #wall2_valid mr.data run function mineraft:structures/walls/check_wall_corner_validity
