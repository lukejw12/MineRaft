function mineraft:structures/walls/check_space

execute if score #space_clear mr.data matches 0 run return fail

function mineraft:structures/walls/place_trapdoors with storage mineraft:walls
function mineraft:structures/walls/spawn_display with storage mineraft:walls
