$summon item_display ~$(x) ~$(y) ~$(z) {item_display:"ground",Tags:["mr.wall_pillar","mr.new_pillar"],transformation:{left_rotation:$(rotation),right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"mineraft:structures/walls/solid_wooden_pillar"}}}
