...
execute as @e[type=item_display,tag=mr.foundation,distance=..2,limit=1,sort=nearest] at @s align xyz run function mineraft:structures/walls/placement/grid/snap
execute as @e[type=item_display,tag=mr.platform_display,distance=..2,limit=1,sort=nearest] at @s align xyz run function mineraft:structures/walls/placement/grid/snap
