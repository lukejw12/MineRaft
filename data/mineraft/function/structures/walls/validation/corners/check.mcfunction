...
execute if data entity @s {data:{side:"west"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_x set value -0.375
...
execute if data entity @s {data:{side:"west"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_z set value 1.625
...
execute if data entity @s {data:{side:"east"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_x set value 0.375
...
execute if data entity @s {data:{side:"east"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_z set value 1.625
...
execute if data entity @s {data:{side:"south"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_x set value 1.625
...
execute if data entity @s {data:{side:"south"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_z set value 0.375
...
execute if data entity @s {data:{side:"north"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_x set value 1.625
...
execute if data entity @s {data:{side:"north"}} if score #found_diagonal mr.data matches 1 run data modify storage mineraft:walls pillar_z set value -0.375
