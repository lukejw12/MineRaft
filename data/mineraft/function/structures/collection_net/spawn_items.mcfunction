...
function mineraft:structures/collection_net/spawn_one with storage mineraft:net

scoreboard players add #display_count mr.data 1
execute if score #display_count mr.data < @s mr.net_items run function mineraft:structures/collection_net/spawn_items