...
function mineraft:structures/collection_net/give_one with storage mineraft:net
scoreboard players add #give_index mr.data 1
execute if score #give_index mr.data < #give_count mr.data run function mineraft:structures/collection_net/give_loop with storage mineraft:net