...
function mineraft:structures/collection_net/interaction/giving/give_items with storage mineraft:net
...
particle minecraft:splash ~ ~0.2 ~ 0.3 0.3 0.3 0 10
playsound block.cobweb.step player @a[tag=mr.net_emptying] ~ ~ ~ 1 1