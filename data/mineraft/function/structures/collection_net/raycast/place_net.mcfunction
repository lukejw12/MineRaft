...
execute as @e[type=item_display,tag=mr.center,limit=1,sort=nearest] at @s run function mineraft:structures/collection_net/placement/grid/place_at_location
