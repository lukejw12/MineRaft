execute as @a if score @s mr.link = #player_link mr.data unless entity @e[type=item_display,tag=mr.net_preview] if score @s mr.link = #player_link mr.data run function mineraft:structures/collection_net/spawn/preview with storage mineraft:net
...
execute if score #abs_x mr.data >= #abs_z mr.data if score #offset_x mr.data matches 1.. run return run execute align xyz positioned ~3 ~ ~ run function mineraft:structures/collection_net/placement/grid/check_and_place_preview
execute if score #abs_x mr.data >= #abs_z mr.data if score #offset_x mr.data matches ..-1 run return run execute align xyz positioned ~-3 ~ ~ run function mineraft:structures/collection_net/placement/grid/check_and_place_preview

execute if score #offset_z mr.data matches 1.. run return run execute align xyz positioned ~ ~ ~3 run function mineraft:structures/collection_net/placement/grid/check_and_place_preview
execute run execute align xyz positioned ~ ~ ~-3 run function mineraft:structures/collection_net/placement/grid/check_and_place_preview