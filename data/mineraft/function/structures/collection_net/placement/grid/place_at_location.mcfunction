...
execute if score #abs_x mr.data >= #abs_z mr.data if score #offset_x mr.data matches 1.. run return run execute align xyz positioned ~3 ~ ~ run function mineraft:structures/collection_net/placement/grid/try_place
execute if score #abs_x mr.data >= #abs_z mr.data if score #offset_x mr.data matches ..-1 run return run execute align xyz positioned ~-3 ~ ~ run function mineraft:structures/collection_net/placement/grid/try_place
execute if score #abs_z mr.data > #abs_x mr.data if score #offset_z mr.data matches 1.. run return run execute align xyz positioned ~ ~ ~3 run function mineraft:structures/collection_net/placement/grid/try_place
execute if score #abs_z mr.data > #abs_x mr.data if score #offset_z mr.data matches ..-1 run return run execute align xyz positioned ~ ~ ~-3 run function mineraft:structures/collection_net/placement/grid/try_place