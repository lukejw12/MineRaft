...
execute align xyz positioned ~ ~1 ~ unless block ~ ~ ~ air unless block ~ ~ ~ iron_trapdoor run function mineraft:structures/water_purifier/raycast/preview/hide
...
execute align xyz positioned ~ ~1 ~ as @e[type=item_display,tag=mr.purifier_preview] if score @s mr.link = #player_link mr.data run function mineraft:structures/water_purifier/raycast/preview/position
