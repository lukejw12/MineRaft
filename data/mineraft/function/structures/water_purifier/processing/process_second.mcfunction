...
execute if score @s mr.purifier_fuel matches 0 run function mineraft:structures/water_purifier/fire/kill
execute if score @s mr.purifier_fuel matches 0 run function mineraft:structures/water_purifier/models/purifying/update
