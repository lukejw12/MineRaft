...
execute as @e[type=item_display,tag=mr.purifier_display] if score @s mr.purifier_id = #purifier_id mr.data at @s run function mineraft:structures/water_purifier/destroy_linked