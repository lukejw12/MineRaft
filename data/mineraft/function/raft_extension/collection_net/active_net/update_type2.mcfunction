...
execute store result entity @s data.Type2.count int 1 run scoreboard players get #new_count temp
execute unless data entity @s data.Type2.data run data modify entity @s data.Type2.data set from storage mineraft:temp Item