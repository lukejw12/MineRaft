...
execute store result entity @s data.Type1.count int 1 run scoreboard players get #new_count temp
execute unless data entity @s data.Type1.data run data modify entity @s data.Type1.data set from storage mineraft:temp Item