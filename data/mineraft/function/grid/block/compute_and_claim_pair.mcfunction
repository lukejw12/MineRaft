...
execute unless score #slot_x mr.data matches 0..2 run return fail
execute unless score #slot_z mr.data matches 0..2 run return fail
execute unless score #slot2_x mr.data matches 0..2 run return fail
