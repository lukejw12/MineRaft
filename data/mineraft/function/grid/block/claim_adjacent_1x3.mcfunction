...
execute unless score #off_z mr.data matches 0 positioned ~ ~ ~-1 as @e[type=item_display,tag=mr.surface,distance=..3,limit=1,sort=nearest] run function mineraft:grid/block/do_claim_adjacent
...
execute unless score #off_x mr.data matches 0 positioned ~-1 ~ ~ as @e[type=item_display,tag=mr.surface,distance=..3,limit=1,sort=nearest] run function mineraft:grid/block/do_claim_adjacent
