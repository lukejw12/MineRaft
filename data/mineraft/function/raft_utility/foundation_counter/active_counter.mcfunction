...
tag @e[type=interaction,tag=counter_break_interact] remove this_counter_break_interact
...
tag @e[tag=this_counter_break_interact] remove this_counter_break_interact