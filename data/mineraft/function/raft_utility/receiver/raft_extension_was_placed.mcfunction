...
execute if block ~ ~-1 ~ #raft_materials if entity @p[y_rotation=-180..-135] positioned ~0.5 ~ ~0.5 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~1 ~ ~ air if block ~1 ~1 ~ air if block ~2 ~ ~ air if block ~2 ~1 ~ air run tag @s add valid_north
...
execute at @s if entity @s[tag=valid_north] run summon item_display ~ ~ ~ {Rotation:[0f,0f],item_display:"ground",Tags:["receiver_facade","recent_spawned"],item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:receiver"}}}
...
execute at @s if entity @s[tag=valid_west] run summon item_display ~ ~ ~ {Rotation:[90f,0f],item_display:"ground",Tags:["receiver_facade","recent_spawned"],item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:receiver"}}}
...
execute if block ~ ~-1 ~ #raft_materials if entity @p[y_rotation=45..135] positioned ~0.5 ~ ~0.5 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~-1 ~ ~ air if block ~-1 ~1 ~ air if block ~-2 ~ ~ air if block ~-2 ~1 ~ air run tag @s add valid_south
...
execute at @s if entity @s[tag=valid_south] run summon item_display ~ ~ ~ {Rotation:[-90f,0f],item_display:"ground",Tags:["receiver_facade","recent_spawned"],item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:receiver"}}}
...
execute if block ~ ~-1 ~ #raft_materials if entity @p[y_rotation=-45..45] positioned ~0.5 ~ ~0.5 if block ~ ~ ~ air if block ~ ~1 ~ air if block ~ ~ ~-1 air if block ~ ~1 ~-1 air if block ~ ~ ~-2 air if block ~ ~1 ~-2 air run tag @s add valid_east
...
execute at @s if entity @s[tag=valid_east] run summon item_display ~ ~ ~ {Rotation:[180f,0f],item_display:"ground",Tags:["receiver_facade","recent_spawned"],item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:receiver"}}}
