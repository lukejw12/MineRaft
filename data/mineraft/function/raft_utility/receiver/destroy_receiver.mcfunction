...
# Drop battery if one is installed
...
execute as @s[tag=facing_north] at @s run fill ~-1 ~ ~ ~1 ~ ~ air
execute as @s[tag=facing_south] at @s run fill ~ ~ ~-1 ~ ~ ~1 air
execute as @s[tag=facing_west] at @s run fill ~ ~ ~-1 ~ ~ ~1 air
execute as @s[tag=facing_east] at @s run fill ~-1 ~ ~ ~1 ~ ~ air
