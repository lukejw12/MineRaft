...
execute at @s if entity @s[tag=valid_north] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["recycler_interact","recent_spawned"]}
...
execute at @s if entity @s[tag=valid_west] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["recycler_interact","recent_spawned"]}
...
execute at @s if entity @s[tag=valid_south] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["recycler_interact","recent_spawned"]}
...
execute at @s if entity @s[tag=valid_east] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["recycler_interact","recent_spawned"]}
...
execute unless entity @s[tag=valid_north] unless entity @s[tag=valid_west] unless entity @s[tag=valid_south] unless entity @s[tag=valid_east] run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{recycler_item:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["recycler"]},"minecraft:item_model":"minecraft:recycler","minecraft:item_name":{"translate":"item.mineraft.recycler","fallback":"Recycler"},"minecraft:rarity":"uncommon"}}}
