...
execute unless block ~ ~ ~ smoker run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{smeltery_item:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["smeltery"]},"minecraft:item_model":"minecraft:smeltery","minecraft:item_name":'Smeltery',"minecraft:rarity":"rare"}}}
