...
execute at @s run item modify entity @e[type=item_display,tag=this_facade,limit=1,distance=0..] contents {function:"set_components",components:{"minecraft:item_model":"minecraft:water_purifier_empty"}}
...
tag @e[tag=has_interaction,type=interaction,distance=0..] remove has_interaction
tag @e[tag=water_click,type=interaction,distance=0..] remove water_click
tag @e[tag=planks_click,type=interaction,distance=0..] remove planks_click
tag @e[tag=bottle_click,type=interaction,distance=0..] remove bottle_click
