...
execute at @s if entity @s[tag=valid_north] run summon interaction ~ ~ ~ {width:1.05,height:1.6,response:true,Tags:["water_purifier_interact"]}
...
execute at @s if entity @s[tag=valid_west] run summon interaction ~ ~ ~ {width:1.05,height:1.6,response:true,Tags:["water_purifier_interact"]}
...
execute at @s if entity @s[tag=valid_south] run summon interaction ~ ~ ~ {width:1.05,height:1.6,response:true,Tags:["water_purifier_interact"]}
...
execute at @s if entity @s[tag=valid_east] run summon interaction ~ ~ ~ {width:1.05,height:1.6,response:true,Tags:["water_purifier_interact"]}
