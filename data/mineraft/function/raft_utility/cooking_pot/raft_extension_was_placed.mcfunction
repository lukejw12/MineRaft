...
execute at @s if entity @s[tag=valid_north] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["cooking_pot_interact"]}
execute at @s if entity @s[tag=valid_north] run scoreboard players operation @e[type=interaction,tag=cooking_pot_interact,sort=nearest,limit=1] cooking_pot = @s cooking_pot
execute at @s if entity @s[tag=valid_north] run summon item_display ~ ~0.3 ~ {Rotation:[180f,0f],item_display:"ground",Tags:["cooking_pot_facade"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:cooking_pot_empty"}}}
...
execute at @s if entity @s[tag=valid_west] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["cooking_pot_interact"]}
execute at @s if entity @s[tag=valid_west] run scoreboard players operation @e[type=interaction,tag=cooking_pot_interact,sort=nearest,limit=1] cooking_pot = @s cooking_pot
execute at @s if entity @s[tag=valid_west] run summon item_display ~ ~0.3 ~ {Rotation:[-90f,0f],item_display:"ground",Tags:["cooking_pot_facade"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:cooking_pot_empty"}}}
...
execute at @s if entity @s[tag=valid_south] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["cooking_pot_interact"]}
execute at @s if entity @s[tag=valid_south] run scoreboard players operation @e[type=interaction,tag=cooking_pot_interact,sort=nearest,limit=1] cooking_pot = @s cooking_pot
execute at @s if entity @s[tag=valid_south] run summon item_display ~ ~0.3 ~ {Rotation:[0f,0f],item_display:"ground",Tags:["cooking_pot_facade"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:barrier",count:1,components:{"minecraft:item_model":"minecraft:cooking_pot_empty"}}}
...
execute at @s if entity @s[tag=valid_east] run summon interaction ~ ~ ~ {width:1.05,height:1.5,response:true,Tags:["cooking_pot_interact"]}
execute at @s if entity @s[tag=valid_east] run scoreboard players operation @e[type=interaction,tag=cooking_pot_interact,sort=nearest,limit=1] cooking_pot = @s cooking_pot
