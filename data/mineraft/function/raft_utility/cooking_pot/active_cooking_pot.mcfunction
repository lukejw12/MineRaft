...
execute unless block ~ ~ ~ barrier run kill @e[type=item_display,distance=..0.5,sort=nearest,limit=1,tag=cooking_pot_facade]
execute unless block ~ ~ ~ barrier run kill @e[type=interaction,distance=..0.5,sort=nearest,limit=1,tag=cooking_pot_interact]
execute unless block ~ ~ ~ barrier run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{cooking_pot_item:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["cooking_pot"]},"minecraft:item_model":"minecraft:cooking_pot","minecraft:item_name":{"fallback":"Cooking Pot","translate":"item.mineraft.cooking_pot"},"minecraft:rarity":"uncommon"}}}
...
execute unless block ~ ~-1 ~ #raft_materials run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{cooking_pot_item:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["cooking_pot"]},"minecraft:item_model":"minecraft:cooking_pot","minecraft:item_name":{"fallback":"Cooking Pot","translate":"item.mineraft.cooking_pot"},"minecraft:rarity":"uncommon"}}}
...
execute as @e[type=marker,tag=this_pot_marker,limit=1] if score @s ingredient_count matches 0 run item modify entity @e[type=item_display,tag=this_pot_facade,limit=1] contents {function:"set_components",components:{"minecraft:item_model":"minecraft:cooking_pot_empty"}}
execute as @e[type=marker,tag=this_pot_marker,limit=1] if score @s ingredient_count matches 1 run item modify entity @e[type=item_display,tag=this_pot_facade,limit=1] contents {function:"set_components",components:{"minecraft:item_model":"minecraft:cooking_pot_layer1"}}
execute as @e[type=marker,tag=this_pot_marker,limit=1] if score @s ingredient_count matches 2 run item modify entity @e[type=item_display,tag=this_pot_facade,limit=1] contents {function:"set_components",components:{"minecraft:item_model":"minecraft:cooking_pot_layer2"}}
execute as @e[type=marker,tag=this_pot_marker,limit=1] if score @s ingredient_count matches 3 run item modify entity @e[type=item_display,tag=this_pot_facade,limit=1] contents {function:"set_components",components:{"minecraft:item_model":"minecraft:cooking_pot_layer3"}}
