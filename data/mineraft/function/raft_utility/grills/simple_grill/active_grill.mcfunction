...
execute unless block ~ ~ ~ blast_furnace run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{simple_grill_item:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["simple_grill"]},"minecraft:item_model":"minecraft:simple_grill_item","minecraft:item_name":{"fallback":"Simple Grill","translate":"item.mineraft.simple_grill"},"minecraft:rarity":"uncommon"}}}
...
execute unless block ~ ~-1 ~ #raft_materials run summon item ~ ~ ~ {Motion:[0.0,0.3,0.0],Item:{id:"minecraft:vex_spawn_egg",count:1,components:{"minecraft:custom_data":{simple_grill_item:1b},"minecraft:entity_data":{id:"minecraft:marker",Tags:["simple_grill"]},"minecraft:item_model":"minecraft:simple_grill_item","minecraft:item_name":{"fallback":"Simple Grill","translate":"item.mineraft.simple_grill"},"minecraft:rarity":"uncommon"}}}
