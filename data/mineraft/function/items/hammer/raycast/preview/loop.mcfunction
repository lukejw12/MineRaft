...
execute if entity @e[type=item_display,distance=..2,tag=mr.stairs_display] run return run function mineraft:items/hammer/raycast/preview/hit {structure:"stairs",tag:"mr.stairs_display"}
