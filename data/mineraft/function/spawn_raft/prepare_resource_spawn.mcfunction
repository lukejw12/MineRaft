...
execute positioned 0 61 0 unless entity @e[type=marker,tag=shark_facing,distance=..5] run summon marker 0 61 0 {Tags:["shark_facing"]}
execute unless entity @e[type=marker,tag=shark_target] run summon marker 0 0 0 {Tags:["shark_target"]}
