...
execute if score #tree_ready dummy matches 1 if score #current weather.state matches 0 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Ready!","color":"green', hydration_color:"aqua", weather_name:"Clear Skies", weather_color:"aqua"}
execute if score #tree_ready dummy matches 1 if score #current weather.state matches 1 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Ready!","color":"green', hydration_color:"aqua", weather_name:"Light Breeze", weather_color:"blue"}
execute if score #tree_ready dummy matches 1 if score #current weather.state matches 2 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Ready!","color":"green', hydration_color:"aqua", weather_name:"Storm", weather_color:"yellow"}
execute if score #tree_ready dummy matches 1 if score #current weather.state matches 3 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Ready!","color":"green', hydration_color:"aqua", weather_name:"Heavy Storm", weather_color:"gold"}

execute if score #tree_empty dummy matches 1 if score #current weather.state matches 0 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Empty","color":"red', hydration_color:"aqua", weather_name:"Clear Skies", weather_color:"aqua"}
execute if score #tree_empty dummy matches 1 if score #current weather.state matches 1 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Empty","color":"red', hydration_color:"aqua", weather_name:"Light Breeze", weather_color:"blue"}
execute if score #tree_empty dummy matches 1 if score #current weather.state matches 2 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Empty","color":"red', hydration_color:"aqua", weather_name:"Storm", weather_color:"yellow"}
execute if score #tree_empty dummy matches 1 if score #current weather.state matches 3 run function mineraft:ui/macros/display_actionbar {pot_section:'"},{"text":" | Empty","color":"red', hydration_color:"aqua", weather_name:"Heavy Storm", weather_color:"gold"}
