...
execute if score @s hydration matches 6.. unless predicate mineraft:looking_at_cooking_pot run function mineraft:ui/display_simple
execute if score @s hydration matches ..5 unless predicate mineraft:looking_at_cooking_pot run function mineraft:ui/display_simple_low