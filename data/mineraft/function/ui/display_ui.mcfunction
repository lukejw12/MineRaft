...
execute if score @s hydration matches 6.. unless predicate mineraft:looking_at_cooking_pot unless predicate mineraft:looking_at_recycler unless predicate mineraft:looking_at_foundation_counter unless predicate mineraft:looking_at_receiver unless predicate mineraft:looking_at_crop_plot unless predicate mineraft:looking_at_tree_plot unless predicate mineraft:looking_at_trading_post run function mineraft:ui/display_simple
execute if score @s hydration matches ..5 unless predicate mineraft:looking_at_cooking_pot unless predicate mineraft:looking_at_recycler unless predicate mineraft:looking_at_foundation_counter unless predicate mineraft:looking_at_receiver unless predicate mineraft:looking_at_crop_plot unless predicate mineraft:looking_at_tree_plot unless predicate mineraft:looking_at_trading_post run function mineraft:ui/display_simple_low