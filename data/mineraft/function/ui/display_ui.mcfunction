...
execute if score @s hydration matches 6.. if predicate mineraft:looking_at_collection_net run function mineraft:ui/collection_net/display
execute if score @s hydration matches ..5 if predicate mineraft:looking_at_collection_net run function mineraft:ui/collection_net/display_low
execute if score @s hydration matches 6.. unless predicate mineraft:looking_at_cooking_pot unless predicate mineraft:looking_at_recycler unless predicate mineraft:looking_at_foundation_counter unless predicate mineraft:looking_at_receiver unless predicate mineraft:looking_at_crop_plot unless predicate mineraft:looking_at_tree_plot unless predicate mineraft:looking_at_trading_post unless predicate mineraft:looking_at_water_purifier unless predicate mineraft:looking_at_collection_net run function mineraft:ui/display_simple
execute if score @s hydration matches ..5 unless predicate mineraft:looking_at_cooking_pot unless predicate mineraft:looking_at_recycler unless predicate mineraft:looking_at_foundation_counter unless predicate mineraft:looking_at_receiver unless predicate mineraft:looking_at_crop_plot unless predicate mineraft:looking_at_tree_plot unless predicate mineraft:looking_at_trading_post unless predicate mineraft:looking_at_water_purifier unless predicate mineraft:looking_at_collection_net run function mineraft:ui/display_simple_low