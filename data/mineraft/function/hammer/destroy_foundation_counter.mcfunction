scoreboard players operation #temp counter_id = @e[type=marker,tag=counter_active,sort=nearest,limit=1,distance=..1] counter_id
...
setblock ~ ~ ~ air
kill @e[type=marker,tag=counter_active,sort=nearest,limit=1,distance=..1]