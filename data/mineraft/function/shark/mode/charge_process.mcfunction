...
execute facing entity @a[tag=mr.my_target,limit=1] feet positioned ^ ^ ^3 if entity @e[type=item_display,tag=mr.foundation,distance=..2] run scoreboard players set #target_y mr.data 56000
